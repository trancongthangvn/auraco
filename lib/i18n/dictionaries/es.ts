...
const dictionary = {
  ...
  footer: {
    ...
    contact: "Contacto",
    copyright: "© 2026 AETHER. Todos los derechos reservados.",
  },
  common: {
    home: "Inicio",
    readMore: "LEER MÁS",
  ...
  account: {
    title: "Mi cuenta",
    subtitle: "Gestiona tus datos y consulta tus pedidos.",
    profileTab: "Información de la cuenta",
    editTab: "Editar datos",
    ...
    emailLocked: "El correo electrónico no se puede cambiar.",
    ...
    myAccount: "Mi cuenta",
    loading: "Cargando...",
    loadError: "No se pudo cargar tu cuenta. Inicia sesión de nuevo.",
