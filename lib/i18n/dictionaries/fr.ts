...
const dictionary = {
  ...
  footer: {
    ...
    contact: "Contact",
    copyright: "© 2026 AETHER. Tous droits réservés.",
  },
  common: {
    home: "Accueil",
    readMore: "LIRE PLUS",
  ...
  account: {
    title: "Mon compte",
    subtitle: "Gérez vos informations et consultez vos commandes.",
    profileTab: "Informations du compte",
    editTab: "Modifier",
    ...
    myAccount: "Mon compte",
    loading: "Chargement...",
    loadError: "Impossible de charger votre compte. Veuillez vous reconnecter.",
