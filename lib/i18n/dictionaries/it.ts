...
const dictionary = {
  ...
  footer: {
    ...
    contact: "Contatti",
    copyright: "© 2026 AETHER. Tutti i diritti riservati.",
  },
  common: {
    home: "Home",
  ...
  account: {
    ...
    subtitle: "Gestisci i tuoi dati e consulta i tuoi ordini.",
    profileTab: "Informazioni account",
    editTab: "Modifica dati",
    ordersTab: "Storico ordini",
    name: "Nome completo",
    email: "Email",
    phone: "Telefono",
    memberSince: "Cliente dal",
    notProvided: "Non indicato",
    editDetails: "Modifica i tuoi dati",
    save: "SALVA MODIFICHE",
    saving: "SALVATAGGIO...",
    saved: "I tuoi dati sono stati salvati.",
    ...
    myAccount: "Il mio account",
    loading: "Caricamento...",
    loadError: "Impossibile caricare il tuo account. Accedi di nuovo.",
